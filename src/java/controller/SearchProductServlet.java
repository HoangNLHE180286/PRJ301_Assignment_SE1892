...
public class SearchProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int zCollID = Integer.parseInt(collId);

        // Kiểm tra xem các giá trị có null hay không
        if (collId == null) {
            collId = "0"; // Giá trị mặc định là "Tất cả"
        }
        ...
        if (collId.equals("0")) {
            ...
            lp = pd.getProductByNameCategoryID(zCollID, name);
        }
